...
object Versions {
    ...
    const val auto_value_annotations: String = "1.6.3" // available: "1.6.5"

    const val auto_value: String = "1.6.5" 

    const val com_google_dagger: String = "2.22.1" // available: "2.23.2"

    const val google_services: String = "4.3.0" 

    const val com_squareup_moshi: String = "1.8.0" 

    const val com_squareup_okhttp3: String = "3.14.2" // available: "4.0.1"

    const val com_squareup_retrofit2: String = "2.6.0" 

    const val de_fayard_buildsrcversions_gradle_plugin: String = "0.3.2" 

    const val android_junit5: String = "1.4.2.1" // available: "1.5.0.0"

    const val de_mannodermaus_junit5: String = "1.0.0" // available: "1.1.0"
